...
* **Real-time Universe Construction:** Developed a custom star-rendering system where each journal entry is mapped to a unique star with specific coordinates and colors.
...
As an exchange student in Hong Kong, I wanted to create a tool that could transform the feeling of late-night solitude into something beautiful. In this app, technology serves as a bridge between raw emotion and artistic expression. By leveraging the declarative nature of SwiftUI, I aimed to push the boundaries of what a "simple utility" can look and feel like.
